...
Additionally this boilerplate supports bot platforms like Dialogflow and wit.ai too. (wit .ai coming soon). This will help you to process and understand the user's intent.
...
### Example 3: Using NLP platforms

NLP platforms can help you analyse the user's intent of a message. Currently only [Dialogflow](https://dialogflow.com/) is integrated which is enough for this demo purpose.
