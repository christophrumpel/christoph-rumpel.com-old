...
What I didn't mention yet is, that there are two W3C versions of CSP. The most modern browsers already support CSP 2.0, but not all. There is only partial support for Internet Explorer, and with Edge, you need at least version 16 to make it work. Depending on your audience this could be a big problem and lead to resources not being loaded on your site. Make sure to check [CSP browser compatibility](https://caniuse.com/#search=content%20secur) before using it.
