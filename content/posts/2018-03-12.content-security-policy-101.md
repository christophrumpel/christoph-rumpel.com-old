...
**Update:** In the article [CSP, hashing, and Turbolinks](https://christoph-rumpel.com/2018/03/content-security-policy-hash-algorithm-and-turbolinks) I explain the CSP hashing feature. Instead of using `unsafe-inline` I can now has the styles and place it in the header.
