...
I am running a chatbot for my book [Build Chatbots with PHP](https://christoph-rumpel.com/build-chatbots-with-php). It works as a messenger newsletter. The user can subscribe to get news on the book via Facebook Messenger. Let's work together through my steps to make it GDPR compliant.
