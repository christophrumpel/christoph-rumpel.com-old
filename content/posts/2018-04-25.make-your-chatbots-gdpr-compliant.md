...
Long and difficult to read terms and conditions are not valid anymore. Prior consent must be given in an accessible and easy form. Withdrawing must be as easy as giving it as well.
...
<br /><br />
As a data controller, I need to make sure my data processors are GDPR compliant. This is done by a `data processing agreement.` Yeah, that's right. You need such an agreement for every of your data processors. In the case of MailChimp, you can create such an agreement automatically on their [site](https://mailchimp.com/legal/forms/data-processing-agreement/). 
<br /><br />
Here is a short list of other services you might already make usage of:

* Provider (DigitalOcean, Linode, etc.)
* Analytic Tools (Google Analytics, etc.)
* Email Marketing (MailChimp, Campaign Monitor, etc.)

Check all of them for given information about if they are GDPR compliant. Most of them also already have agreements prepared for you. If you don't find any info on their websites, contact them.

### Documentation
The accountability principle requires you to document that your organization processes personal information in line with the GDPR. Next, to the mentioned processor agreements, you need to `maintain a record of processing activities`. This is true for controllers and processors at the same time. It forces you to write down what data you collect for which reasons and who you share it with. If there is an investigation, you will need to provide this information. This is the base for every other to make your business and projects GDPR compliant.
...
<br /><br />
In general, GDPR for chatbots is very similar to any other application. It's all about giving your user enough information on what is happening with their personal data, before you store it.
...
6. Provide enough and precise information about used data.
...
The General Data Protection Regulation brings a lot of changes to the web. It is an entire complex topic, and you need to take some time to make yourself familiar with. Everybody is trying right now to make their products GDPR compliant and as you have seen it is not that easy and clear what it takes. I hope this article could help you to get a better understanding of this new regulation and what it means for your chatbots.
<br /><br />
This article focused on the project site of GDPR. Please keep in mind that there is much more for you or your company to consider to fulfill the GDPR. 
