        ...
        <div class="flex flex-col items-center mt-4 bg-white mt-12 relative">
            ...
            <div class="flex mt-4 mb-4 justify-center">
                <div class="w-4/5 md:w-100 font-landing text-grey-darkest text-lg">
                    ...
                    <p class="mb-4">When I started building chatbots in 2016 there wasn't a single tutorial available on how to do that with PHP. The only way of learning how to do so was by/through trial and error, but I made it through! Now, two years later, you will find some blog posts on the subject, but still not much. With this book I want to change that and give everyone <b>the perfect starting point for building chatbots with PHP.</b></p>
