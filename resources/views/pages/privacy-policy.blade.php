    ...
    <div class="container mx-auto  max-w-5xl p-12">
        <article class="page">
            ...
            <p>Christoph Rumpel is committed to ensuring that your privacy is protected. Should we ask you to provide
                certain information by which you can be identified when using christoph-rumpel.com, then you can be
            ...
            <p>The information is stored as long as you are subscribed to one of the newsletters. When you end the
                subscription, it will automatically be deleted.</p>
