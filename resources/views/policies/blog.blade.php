...
@section('content')
    <article>
        ...
        <h1>Business Privacy Policy - Blog christoph-rumpel.com</h1>

        <p>This privacy policy sets out how Christoph Rumpel uses and protects any information that you give Christoph
            Rumpel when you visit christoph-rumpel.com</p>

        <p>Christoph Rumpel is committed to ensuring that your privacy is protected. Should we ask you to provide
            certain information by which you can be identified when using christoph-rumpel.com, then you can be assured that it will
