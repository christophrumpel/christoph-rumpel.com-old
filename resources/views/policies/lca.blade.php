...
@section('content')
    <article>
        ...
        <p>This privacy policy sets out how Christoph Rumpel uses and protects any information that you give Christoph Rumpel when you visit laravelcoreadventures.com</p>

        <p>Christoph Rumpel is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using laravelcoreadventures.com, then you can be assured that it will only be used in accordance with this privacy statement.</p>
