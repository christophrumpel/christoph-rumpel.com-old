        ...
        <ul class="list-reset">
            ...
            @foreach($talks as $talk)
                <li class="mb-8 w-full list-reset bg-grey-lighter p-4">
                    <p><time class="mb-0 text-grey-darkest font-bold uppercase text-sm font-sans">{{ $talk->date }} |
